...
In diversi casi ci capiterà di analizzare dataset caratterizzati da un gran numero di attributi. Diminuirne il numero porta a diversi vantaggi:
...
\[s = [\log_{2}k]\] 
 ...
 Quando invece abbiamo a che fare con attributi durante un'analisi di classificazione o di associazione ricordiamo alla tecnica di \textbf{discretizzazione.} Come facilmente intuibile la miglior discretizzazione dipende dal tipo di algoritmo che sto utilizzando.
